        ...
        <div class="row">
           <div class="col-sm-12 col-lg-7">
              <div class="bannertext">
              	...
              	?>
              	<div class="yearRow">
              		<span><strong>18+</strong> Years Experience</span>
...
<section class="servicesRow" id="services">
	 <div class="hire-container">
	    <div class="row">
	       ...
	       <div class="col-lg-12 text-center">
	          ...
	          <a href="<?php //echo $hire_block['cta_link'];?>#footForm" title="<?php echo $hire_block['cta_text']; ?>" class="button-yel">Contact us now</a>
	       	</div>
	   		<?php endif; ?>
	    </div>
	 </div>
...
?>
<?php 
$casestudy = get_field('case_study', $page_id);
if( $casestudy && !empty($casestudy['title']) ) :
?>
...
<div class="row">
   <div class="col-lg-12 headingRow">
      ...
      <p><?php echo $casestudy['content']; ?></p>
   </div>
</div>

<?php 
$cSlides = $casestudy['case_study']; 
if( $cSlides ) :
?>
<div class="row justify-content-center">
   <div class="col-lg-10">   	
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
         <div class="carousel-inner">
         	...
         	$cs++;
         	$isActive = ( $cs === 1 ) ? " active" : "";
			echo '<div class="carousel-item '.$isActive.'">
			<div class="casestudie">';
			if( $slide['image'] && $slide['image_webp'] ){
				echo '<picture>
                   <source type="image/webp" srcset="'.$slide['image_webp']['url'].'" width="'.$slide['image']['width'].'" height="'.$slide['image']['height'].'">
                   <source type="'.$slide['image']['mime_type'].'" srcset="'.$slide['image']['url'].'" width="'.$slide['image']['width'].'" height="'.$slide['image']['height'].'">
                   <img src="'.$slide['image']['url'].'" alt="'.$slide['title'].'" width="'.$slide['image']['width'].'" height="'.$slide['image']['height'].'">
                </picture>';
			}
			echo '<div class="casedetail">
				<h3>'.$slide['title'].'</h3>
...
<section class="easy-steps">
	...
	<div class="col-md-6 col-lg-3 text-center">
		<div class="stepBox">
			...
			<h3>Send us your detailed project requirements</h3>
		</div>
	</div>
	<div class="col-md-6 col-lg-3 text-center">
		<div class="stepBox">
			...
			<h3>Select candidates for screening process</h3>
		</div>
	</div>
	<div class="col-md-6 col-lg-3 text-center">
		<div class="stepBox">
			...
			<h3>Take interview of selected candidates</h3>
		</div>
	</div>
	<div class="col-md-6 col-lg-3 text-center">
		<div class="stepBox">
			...
			<h3>Initiate project on-boarding & assign tasks</h3>
		</div>
	</div>
...
if( $hire_steps ) :
?>
<section class="easy-steps hiring-process-section"  id="hiring-process">
	<div class="hire-container">
		...
		<!--<picture class="lighter-theme-img">
         ...
         <picture class="lighter-theme-img">
        <source type="image/webp" srcset="https://www.valuecoders.com/l/wp-content/uploads/2022/07/our-hiring-process-img-for-lighter21.webp">
        <source type="image/png" srcset="https://www.valuecoders.com/l/wp-content/uploads/2022/07/our-hiring-process-img-for-lighter21.png">
        <img loading="lazy" src="https://www.valuecoders.com/l/wp-content/uploads/2022/07/our-hiring-process-img-for-lighter21.png" alt="Valuecoders" width="1620" height="315">
        </picture>
		...
		<div class="dis-flex justify-center hiring-step-sprite">
           ...
           <div class="col-12 text-center"><a href="#footForm" title="Contact Us Now" class="button-yel">Contact Us Now</a></div>
...
if( $hiring_models ) :
?>
<section class="hiringRow" id="engagement-options">
	<div class="hire-container">
		<div class="row">
...
<section class="awardsRow cpageBg" id="partners-awards">
   <div class="custom-container">
      <div class="row">
         <div class="col-lg-12 headingRow">
...
<?php }?>
<?php if(!wp_is_mobile()){ ?>
<div class="fromsec" id="contact-us">
   <div class="headingRow">
      <h2>Get In Touch</h2>
