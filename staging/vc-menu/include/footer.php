    ...
    <div class="container">
        <div class="dis-flex">
            ...
            <div class="footer-last">
                <picture>
                    <source type="image/webp" srcset="<?=HOST_URL?>images/footer-iso-logo.webp">
                    <source type="image/png" srcset="<?=HOST_URL?>images/footer-iso-logo.png">
                    <img loading="lazy" src="<?=HOST_URL?>images/footer-iso-logo.png" alt="Valuecoders" width="97" height="69">
                </picture>
