      ...
      <div class="container">
        <div class="dis-flex form-outer">
          ...
          <div class="slider-right">
            ...
            <picture>
              <source type="image/webp" srcset="<?=HOST_URL?>images/contact-client-logo.webp">
              <source type="image/png" srcset="<?=HOST_URL?>images/contact-client-logo.png">
              <img loading="lazy" src="<?=HOST_URL?>images/contact-client-logo.png" alt="Valuecoders" width="316" height="164">
            </picture>
