    ...
    <div class="container">
        <div class="dis-flex">
            <div class="footer-left">
                ...
                <!-- <span class="resources-links">
                    <h4 class="clr-white">Resources:</h4>
                ...
                <!-- 
                <span class="theme-setting nav-toggle">
                    <span class="theme">Theme</span> <span class="lighter-theme" id="themeBtn"><i class="icon icon1 vlazy"></i> Light</span> <span class="divider">|</span> <span class="dark-theme" id="themeDarkBtn"><i class="icon icon2 vlazy"></i> Dark</span> <span class="divider">|</span> <span class="auto-theme" id="themeAuto"><i class="icon icon3 vlazy"></i> Auto</span></span> 
                -->
            </div>
