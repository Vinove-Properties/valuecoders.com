<?php
/*
Template Name: Contact Page - v7 {Custom Select} Template
*/ 
global $post;
$thisPostID = $post->ID;
get_header();
			...
			<div class="form-box-outer right-box" style="padding-top:40px;">
				...
				<form action="<?php bloginfo('url'); ?>/sendmail1.php" enctype="multipart/form-data" method="POST" id="contact-form-section" onsubmit="return vcCmnFormValidation();"  style="margin-top:40px;">
					...
					<div class="form-inner dis-flex">
						...
						<div class="form-text-cont cont_country_section">
							<div class="row-left">
								...
								<div class="user-input">
										...
										onkeydown="javascript:if(event.keyCode != 9){ 
											if(event.keyCode == 13){
											setTimeout(function(){ 
											document.getElementsByClassName('iti__selected-flag')[0].dispatchEvent(
											new Event('click'));
											}, 1);
											}
											return false; 
										};" tabindex="-1" onmousedown="return false;">
							...
							<div class="row-right no-erro-fld">
								...
								<div class="user-input">
									<input class="input-field input-extension" id="in_ext" type="number" placeholder="" autocomplete="off" value="" maxlength="5" name="user-extension" />
								</div>
							</div>
						</div>
						<div class="form-text-cont">
						...
						<button class="nxt-btn" id="btn-step-one" type="button" onclick="return vcStepOneCheckert();">Save and Continue</button>
						</div>
						</div>
						<br>
						<br>
						<!--<div class="step-head"><h2>Your Requirements</h2></div>-->
						...
						<div class="step-head active"><h2>Your Requirements</h2></div>
