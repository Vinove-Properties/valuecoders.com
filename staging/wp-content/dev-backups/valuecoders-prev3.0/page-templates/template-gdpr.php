...
<section class="gdpr-compliance-section">
    <div class="container">
      ...
      <div class="gdpr-compliance-outer">
        ...
        <div class="gdpr-compliance-outer">
            <h2>ValueCoders’ Approach To Compliance</h2>
...
<section class="gdpr-three-column-icon-section padding-b-150">
    <div class="container">
