<?php
/*
Template Name: Contact Page - v4 MS Template
*/ 
global $post;
$thisPostID = $post->ID;
get_header();
				...
				<form action="<?php bloginfo('url'); ?>/sendmail1.php" enctype="multipart/form-data" method="POST" id="contact-form-section"  onsubmit="return vcCmnFormValidation();"  style="margin-top:40px;">
					...
					<div class="form-inner">
						...
						<div class="form-text-cont">
							...
							<div class="user-input">
								<input type="text" class="input-field" placeholder="Enter your Phone Number" value="" id="cont_phpne" maxlength="18" name="user-phone"/>
								<small>Error Message</small>
							</div>
						</div>
						<div class="form-text-cont">
							...
							<div class="user-input">
								<input class="input-field input-skype" id="cont_country" type="text" placeholder="Enter your country" maxlength="50" autocomplete="off" value="" name="user-country" />
								<small>Error Message</small>
							</div>
						</div>
