...
<section class="contact-us-section full-width-form padding-b-150">
	<div class="container">
		...
		<div class="bg-voilet">
			...
			<form action="<?php bloginfo('url'); ?>/sendmail1.php" enctype="multipart/form-data" method="POST" id="contact-form-section" onsubmit="return vcCmnFormValidation();"  style="margin-top:40px;">
					...
					<div class="form-inner dis-flex">
						...
						<button class="nxt-btn" id="btn-step-one" type="button" onclick="return vcStepOneCheckert();">Continue</button>
						</div>
						</div>
						<br>
						<br>
		...
		<picture>
        <img src="<?php bloginfo('template_url'); ?>/images/contact-client-logo-image-light.svg" class="Client Logo" width="364" height="274">
		</picture>
		<?php }else{ ?>
		<picture>
		<img src="<?php bloginfo('template_url'); ?>/images/contact-client-logo-image.svg" class="Client Logo" width="364" height="274" loading="lazy">
		</picture>	
		<?php }
		?>
		<!-- 
...
<style>
.form-footer-section .form-footer .flex-3:nth-child(3) .title {
