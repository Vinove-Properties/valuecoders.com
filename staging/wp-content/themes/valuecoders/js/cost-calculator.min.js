...
// xhr.open("GET", calcObj.tpl_url+"/json-fields/data-analytics-bi-calculator-formatted.json", true);
...
document.getElementById("submitBtn").addEventListener("click", function (event){
    if( !validateStep(currentStep) ){   
        ...
        //formDataObj.action = 'handlecosting';
        console.log( formDataObj );
        //fetch(`${calcObj.admin_ajax}`, {
