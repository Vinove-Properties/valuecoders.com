<?php
/*
Template Name: Contact Page - v6 {Remove Company} Template
*/ 
global $post;
$thisPostID = $post->ID;
get_header();
					...
					<div class="form-inner dis-flex">
						...
						<div class="form-text-cont cont_country_section">
							...
							<div class="row-right no-erro-fld">
								...
								<div class="user-input">
									<input class="input-field input-extension" id="in_ext" type="tel" placeholder="" autocomplete="off" value="" maxlength="5" name="user-extension" />
								</div>
							</div>
						</div>
						<div class="nxt-btn-box">
						<button class="nxt-btn" type="button" onclick="return vcStepOneCheckert();">Save and Continue</button>
						</div>
						</div>
						<br>
						<br>
