    ...
    <div class="dis-flex justify-sb">
      ...
      <div class="flex-2 right-box">
        <?php 
          ...
          ?>
        <picture>
          <source type="image/webp" srcset="<?php bloginfo('template_url'); ?>/v4.0/images/hire-bannerright.webp">
          <source type="image/png" srcset="<?php bloginfo('template_url'); ?>/v4.0/images/hire-bannerright.png">
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/v4.0/images/hire-bannerright.png" alt="Valuecoders" width="689" height="477"> 
        </picture>
        <?php } ?>
      </div>
    </div>
...
<section class="table-list-section <?php echo $compAnalysis['sc_background']; ?> padding-t-150 padding-b-150">
  ...
  <div class="container">
    ...
    <?php endif; ?>
    <div class="view-more margin-t-50 text-center"><a href="/contact">View More</a></div>
  </div>
  <?php endwhile; ?>
  <?php endif; ?>
</section>
...
<section class="accordion-section list-full padding-t-120" id="acf-code-quality-accordian-static">
  <div class="dis-flex accordian-row">
    <div class="col-left">
      ...
      <div class="image-wrap">
        <picture class="soft-img">
          <source type="image/webp" srcset="<?php bloginfo('template_url'); ?>/v4.0/images/code-quality-image.webp">
          <source type="image/png" srcset="<?php bloginfo('template_url'); ?>/v4.0/images/code-quality-image.png">
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/v4.0/images/code-quality-image.png" width="666" height="536" alt="valuecoders">
        </picture>
      </div>
    </div>
    <div class="col-right padding-b-120">
