  ...
  <div class="dis-flex justify-sb">
    <div class="left-box">
      <div class="soc-box dis-flex items-center">                
        <a href="javascript:void(0);" onclick="consultCTA_cb();"><i><img loading="lazy" src="<?php _vers_six('images/home-images/connect-01.svg'); ?>" alt="valuecoders" width="20" height="20"></i><span>Book A Call</span></a>
        <a href="https://wa.me/918882108080" target="_blank"><i><img loading="lazy" src="<?php _vers_six('images/home-images/connect-02.svg'); ?>" alt="valuecoders" width="20" height="20"> </i><span>WhatsApp</span></a>
      ...
      <div class="award-box">
        ...
        <div class="row-box">
          ...
          <div class="col-box dis-flex">
            <div class="icon"><img loading="lazy" src="<?php _vers_six('images/home-images/cont-02.svg'); ?>" alt="pixel" width="40" height="40"></div>
            <div class="desp">
          ...
          <div class="col-box dis-flex">
            <div class="icon"><img loading="lazy" src="<?php _vers_six('images/home-images/cont-03.svg'); ?>" alt="pixel" width="40" height="40"></div>
            <div class="desp">
        ...
        <div class="client-stack">
          <ul>
          <li>
          <picture><img loading="lazy" src="<?php _vers_six('images/home-images/fot-01.svg'); ?>" alt="Valuecoders" width="107" height="60"></picture>
          </li>
          <li>
          <picture><img loading="lazy" src="<?php _vers_six('images/home-images/fot-02.svg'); ?>" alt="Valuecoders" width="107" height="60"></picture>
          </li>
          <li>
          <picture><img loading="lazy" src="<?php _vers_six('images/home-images/fot-03.svg'); ?>" alt="Valuecoders" width="107" height="60"></picture>
          </li>
          </ul>
        </div>
      </div>
