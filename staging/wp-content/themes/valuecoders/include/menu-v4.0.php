        ...
        <nav class="menu mob-nav" id="menu">
          <ul>
                    ...
                    <div id="menu-inds" class="dis-flex tab-contents">
                      ...
                      <div class="right-tabs">
                        <div class="tab-content is-active">
                          <div class="three-column">
                            <div class="tab-title"><a href="<?php echo $site_url; ?>outsource-software-product-development-services"><img loading="lazy" src="<?php echo $tpl_url; ?>/v4.0/header-images/ind-03.svg" class="menuicon" alt="menuicon"><span class="title">Software Startups & Product Companies</span>Your vision, our expertise</a>
                            </div>
            ...
            <li class="menu-item-has-children hire-menu-item">
              <a class="mst-link" href="<?php echo $site_url; ?>hire-developers">Hire <i><img class="nor" loading="lazy" src="<?php echo $tpl_url; ?>/v6.0/header-images/header-images/hire-icon.png"><img class="hov" loading="lazy" src="<?php echo $tpl_url; ?>/v6.0/header-images/hire-yellow.png"></i></a> <span class="arrow-btn"></span>
              <div class="menu-mega">
                <div class="container">
                  <div class="dis-flex tab-menu">
