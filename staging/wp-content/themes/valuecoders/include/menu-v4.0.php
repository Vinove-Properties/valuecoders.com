    ...
    <div class="wrapper">
      <div class="header-item-left">
        <a href="https://www.valuecoders.com/staging/" class="brand">
          <div class="large">
            <img class="light" loading="lazy" src="<?php bloginfo('template_url'); ?>/v4.0/header-images/logo-light.svg" alt="Valuecoders" width="400" height="88">
            <img class="dark" loading="lazy" src="<?php bloginfo('template_url'); ?>/v4.0/header-images/logo-dark.svg" alt="Valuecoders" width="400" height="88">
          </div>
          <div class="small">
            <img loading="lazy" src="<?php bloginfo('template_url'); ?>/v4.0/header-images/logo-small.svg" alt="Valuecoders" width="80" height="80">
          </div>
        </a>
      </div>
