                                            ...
                                            <div class="dis-flex" id="active_Current_Tabs2">
                                                <div class="width-33 middle-list">
													...
													<div class="sub-child hr-menu-mega">
														...
														<a href="<?php echo $site_url; ?>startup-consulting-services">Startup Consulting</a>
														<a href="<?php echo $site_url; ?>startup-product-development">Product Development for Startups</a>
                                                        <a href="<?php echo $site_url; ?>discovery-phase-process">Product Discovery Phase</a>
                                                ...
                                                <div class="width-33 middle-list">
													...
													<div class="sub-child hr-menu-mega">
                                                        ...
                                                        <a href="<?php echo $site_url; ?>cto-as-a-service">CTO as a Service</a>
														...
														<a href="<?php echo $site_url; ?>hire-developers/hire-shadow-engineer">Shadow Engineers</a>
														<a href="<?php echo $site_url; ?>ratecard">Rate Card</a>
													</div>
												</div>
                                                <div class="width-33 middle-list">
                                                    <div class="hr-list-item">
                                            ...
                                            <div class="dis-flex" id="active_Current_Tabs3">
												<div class="width-33 middle-list">
													...
													<div class="sub-child hr-menu-mega">
														...
														<a href="<?php echo $site_url; ?>android-app-development-company-india">Android App Development</a>
                                            ...
                                            <div class="dis-flex last-list" id="active_Current_Tabs0">
                                                ...
                                                <div class="width-20 last-list">
                                                    ...
                                                    <div class="hr-menu-mega">
                                                        ...
                                                        <a href="<?php echo $site_url; ?>pega-development" title="Pega Development">Pega Development</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="hr-menu-mega">
                                                        <div class="dis-flex">
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href="<?php echo $site_url; ?>hr-software-solutions">Human Resource Management</a>
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href="<?php echo $site_url; ?>document-management-services">Document management</a>
                                                            </div>
