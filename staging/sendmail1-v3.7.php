...
if( $isAjay === true ){
    ...
    $user_country   = vcGetCountryByCode($ajxData['country']);
    $varIPAdd       = get_client_ip_user();    
    if( isset($_SESSION["queryString"]) && !empty($_SESSION["queryString"]) ){
    ...
    $mailSent = smtpEmailFunction( "ankur@valuecoders.com", "Inquiry with ValueCoders", $Mailbody, "lead", 
    ...
    if(!$isSpam) {
        ...
        //if($result) {
            ...
            */
            ...
            $user_email, [], ['zeba.khan@mail.vinove.com'], [], $user_name );
