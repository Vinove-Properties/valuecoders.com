...
'Cyprus'
    ...
    if( checkInArray( $is_country, $array_other ) ){
        $consoleArray = array( 
            'region'    => 'other',
            'lead_to'   => $zoho_id['ankur'], 
            'mail_to'   => 'ankur@valuecoders.com', 
        ...
        $consoleArray = array( 
            'region'    => 'apac', 
            'lead_to'   => $zoho_id['atul'], 
            'mail_to'   => 'atul.srivastava@valuecoders.com', 
            'mail_cc'   => ['ankur@valuecoders.com'] 
        );
    }elseif( checkInArray( $is_country, $array_uk ) ){
        $consoleArray = array( 
            'region'    => 'uk', 
            'lead_to'   => $zoho_id['avi'], 
            'mail_to'   => 'avi@valuecoders.com', 
            'mail_cc'   => ['ankur@valuecoders.com'] 
        );
    ...
    elseif( strtolower($is_country) == 'india' ){
        $consoleArray = array( 
            ...
            'lead_to'   => $zoho_id['ankur'], 
            'mail_to'   => 'ankur@valuecoders.com', 
            'mail_cc'   => ['akhil@valuecoders.com', 'atul.srivastava@valuecoders.com'] 
        );
    }else{
        $consoleArray = array( 
            'region'    => 'na', 
