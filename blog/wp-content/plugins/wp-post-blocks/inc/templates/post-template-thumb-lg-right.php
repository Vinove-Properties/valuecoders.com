...
/**
 * Post Module Thumb Lg - Post thumbnail is on the right
 * @since 1.0
 * 
 */
...
if( !class_exists( 'Post_Template_Thumb_Lg_Right') ){

	if( !class_exists( 'Post_Template' ) ){
		require_once Plugin::get_dir() . 'inc/post-template.php';
	}

	class Post_Template_Thumb_Lg_Right extends Post_Template{
		static $thumb_size = 'post-thumbnail';
		static $uid			= 'pbs-module-thumb-lg-right';
		/**
		 * Render the block
		 */
