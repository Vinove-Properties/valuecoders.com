...
$category_detail=get_the_category($postid);//post category
...
$message .= '<p><a href="https://www.valuecoders.com/blog/'.$slug.'/'.$posttitle.'/?ep-action=show&email='.$email.'&hash='.$hash.'">https://www.valuecoders.com/blog/'.$slug.'/'.$posttitle.'/?ep-action=show&email='.$email.'&hash='.$hash.'</a></p>';
...
$headers .= 'From:Valuecoders<marketing@valuecoders.com>' . "\r\n"; // Set from headers
