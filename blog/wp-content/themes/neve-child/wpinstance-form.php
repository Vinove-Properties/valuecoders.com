<?php 
$vcThemeUrl = "https://www.valuecoders.com/wp-content/themes/valuecoders/";
?>
...
<div class="container">
		<div class="dis-flex">
			...
			<div class="form-box-outer right-box bg-voilet">
				<form id="contact-form-section" action="https://www.valuecoders.com/sendmail1.php" class="contact-form-section" enctype="multipart/form-data" method="POST" onsubmit="return vcCmnFormValidation(false);">
					...
					<div class="user-input checkout">
						...
						<input type="hidden" name="frmqueryString" value="<?php echo ( is_front_page() || is_home() ) ? get_site_url() : get_the_permalink(); ?>">
						<input type="hidden" name="vc_csrf" value="">
						<input type="hidden" name="vc-form-type" value="blog">
				  ...
				  reader.onloadend = function() {
				  	...
				  	switch (file.type) {
						case 'application/pdf':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/pdf_gy.png";     
						    break;
						case 'application/vnd.openxmlformats-officedocument.wordprocessingml.document':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/doc_gy.png"; 
						    break;
						case 'text/plain':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/doc_gy.png"; 
						    break;    
						case 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet':
						    icon =  "<?php echo $vcThemeUrl; ?>/dev-img/xls_gy.png"; 
						    break;
						case 'application/vnd.ms-excel':
						    icon =  "<?php echo $vcThemeUrl; ?>/dev-img/xls_gy.png"; 
						    break;    
						case 'image/vnd.adobe.photoshop':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/psd_gy.png";
						    break;
						case 'application/x-zip-compressed':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/zip_gy.png";
						    break;
						case 'application/zip':
						    icon = "<?php echo $vcThemeUrl; ?>/dev-img/zip_gy.png";
						    break;						    
						default:
							icon = "<?php echo $vcThemeUrl; ?>/dev-img/def-thumb.png";
							break;
					}
					//if size exceed than 10 MB
				        if(file.size > 10000000 && file.type == 'image/jpeg') {
				           	icon = "<?php echo $vcThemeUrl; ?>/dev-img/jpg_gy.png" ;
				        } else if(file.size > 10000000 && file.type == 'image/png') {
				           	icon = "<?php echo $vcThemeUrl; ?>/dev-img/png_gy.png";
				        }
...
// End Preview File
	    ...
	    xhttp.setRequestHeader( 'Access-Control-Allow-Origin', 'beta.vinove.com' );
	    xhttp.send(form_data);
	// }
}
