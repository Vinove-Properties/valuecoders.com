...
<div class="container">
  <div class="dis-flex justify-sb">
    ...
    <div class="dis-flex  items-center award-logo">
      <div class="logo-box">
        <picture>
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/images/footer-aw-01.svg" alt="Valuecoders" width="75" height="46"> 
        </picture>
      </div>
      <div class="logo-box">
        <picture>
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/images/footer-aw-02.svg" alt="Valuecoders" width="90" height="22"> 
        </picture>
      </div>
      <div class="logo-box">
        <picture>
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/images/footer-aw-03.svg" alt="Valuecoders" width="114" height="35"> 
        </picture>
      </div>
      <div class="logo-box">
        <picture>
          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/images/footer-aw-04.svg" alt="Valuecoders" width="84" height="34"> 
        </picture>
      </div>
    </div>
    </div>
