    ...
    <div class="wrapper">
      <div class="header-item-left">
       <a href="<?php echo $site_url; ?>" class="brand">
        <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.png" alt="Logo" class="dark-theme-logo" width="301" height="52"/>
        <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo-blue.png" alt="Logo" class="day-theme-logo" width="301" height="52"/>
        </a>
      </div>
      <!-- Navbar Section -->
        ...
        <div class="menu" id="menu">
          <ul>
            <li class="menu-item-has-children">
              <a href="<?php echo $site_url; ?>custom-software-development-services-company">Services</a>
              <div class="menu-mega">
                <div class="container">
                    ...
                    <div class="width-75 header-menu" id="b1">
                      <div class="dis-flex" id="active_Current_Tabs2">
                        <div class="width-40 middle-list">
                          ...
                          <!-- <a href="#" class="text-column" id="
                            " data-section="active_Current_Tabs2">How it Works</a> -->
                        ...
                        <div class="width-60 last-list">
                          ...
                          <div class="header-menu" id="b21">
                            <p><strong>Onshore & Offshore Dedicated Software Teams </strong>
                              Build scalable, secure, and robust software solutions with our experienced, skilled, reliable, & professional software development teams.
                            </p>
                          </div>
                          <div class="header-menu" id="b22">
                            <p><strong>IT Staff Augmentation Services In India</strong>
                              We bridge the gap between demand and supply for skilled development teams through an innovative and best-in-class recruiting model backed by a dedicated client-centric software development team.
                            </p>
                          </div>
                          ...
                          <div class="header-menu" id="b26">
                            <p><strong>Why Outsource Software Development Services in India</strong>
                              India has always been a preferred destination for businesses across the globe to outsource their software projects. Here are some recent stats related to software outsourcing in India:
                            </p>
                          </div>
                        ...
                        <div class="width-60 last-list">
                          <div class="header-menu active mrow mrow-3" id="b80">
                            <p><strong>What is Smart Automation?</strong>
                              Smart automation, sometimes also called cognitive automation, is the use of automation technologies – artificial intelligence (AI), IoT, business process management (BPM), and robotic process automation (RPA) – to streamline and scale decision-making across organizations.
                            </p>
                          </div>
            ...
            <li class="menu-item-has-children small-menu">
...
<?php //endif; ?>
<?php //if( wp_is_mobile() ) : ?>
<header class="header-mobile header-two <?php echo ( wp_is_mobile() ) ? ' vc-mob-menu' : ''; ?>">
  <div class="container">
    <div class="header-top">
      <a href="<?php echo $site_url; ?>" class="mobile-logo">
      <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.png" alt="Logo" class="logo dark-theme-logo" width="301" height="52">
      <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo-blue.png" alt="Logo" class="logo day-theme-logo" width="301" height="52">
      </a>
    ...
    <nav class="mob-nav">
      <div class="menu-list first" id="dropdownmwrap1">
        <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.png" alt="Logo" class="logo dark-theme-logo" width="301" 
          height="52">
        <img loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo-blue.png" alt="Logo" class="logo day-theme-logo" width="301" height="52">
        <ul>
          ...
          <li>
            <a href="<?php echo $site_url; ?>about">Company</a> <span class="arrow-btn" onclick="innermenu(this,'main2')"></span>
      ...
      <div class="menu-list second" id="dropdownmwrap">
        ...
        <ul>
          <li>
            <a href="<?php echo $site_url; ?>hire-developers">Hire Software Developers</a> <span class="arrow-btn" onclick="innermenu(this, 'main0')"></span>
          ...
          <li>
            <a href="#">Smart Teams</a> <span class="arrow-btn" onclick="innermenu(this, 'inner1')"></span>
          ...
          <li>
            <a href="#">Engineering Services</a> <span class="arrow-btn" onclick="innermenu(this, 'inner2')"></span>
          ...
          <li>
            <a href="#">Smart Automation</a> <span class="arrow-btn" onclick="innermenu(this, 'inner3')"></span>
          ...
          <li>
            <a href="#">Technology Advisory</a> <span class="arrow-btn" onclick="innermenu(this, 'inner4')"></span>
