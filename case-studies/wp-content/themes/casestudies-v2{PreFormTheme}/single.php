...
<?php
  ...
  */
  ...
  //echo $bg_css;
  ?>  
<section class="hero-section" style='<?php echo $bg_css;?>'>
  <div class="container">
...
*/
?>
<section class="case-section padding-t-150 padding-b-150">
  <div class="container">
                ...
                <div class="case-slider">
                  <div class="glider-content">
                    <div class="press-glider">
                      ...
                      <div class="press-row">
                        <img src="<?php echo $image['url'];?>" alt="<?php echo $postttile; ?>"/>
                      </div>
                      <?php 
                        $in++;
                        } ?>
