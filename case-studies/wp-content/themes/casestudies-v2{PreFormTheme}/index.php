<?php get_header(); ?>
<section class="full-width-two-column padding-t-150">
  <div class="row">
    <div class="container">
  		...
  		<div class="custom">
              ...
              <div class="nopost"></div>
	  			<div class="lode_mor_btn hidepost">
	  				<span class="ajax-loader"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/ajax-loader.gif" height="32" width="32" alt="Loader" id="loaderImg" style="display: none;"></span><a href="javascript:void(0);" class="btn green-btn" id="load_more_post"> Load More <i class="arrow-icon"></i> </a>
	  			</div>
	  		</div>
	  	</div>
  	</section>
