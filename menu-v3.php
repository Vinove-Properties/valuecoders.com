            ...
            <div class="header-item-center">
                <nav class="menu" id="menu">
                    <ul>
                                ...
                                <div class="container">
                                    <div class="dis-flex" id="active_Current_Tabs1">
                                        <div class="width-25 for-padding left-list">
                                            ...
                                            <a href="javascript:void(0)" class="text-column" id="a4" data-section="active_Current_Tabs1" data-mrow="4">Others</a>
                                        </div>
                                            ...
                                            <div class="dis-flex" id="active_Current_Tabs2">
                                                <div class="width-33 middle-list">
													...
													<div class="sub-child">
														...
														<!-- <a href="<?php echo $site_url; ?>new_page">Startup Consulting</a>
														<a href="<?php echo $site_url; ?>new_page">Product Development for Startups</a>
														<a href="<?php echo $site_url; ?>new_page">Product UI/UX Design</a> -->
													</div>
												</div>
                                                ...
                                                <div class="width-33 middle-list">
													...
													<a href="<?php echo $site_url; ?>white-label-services" class="title">Whitelabel Services</a>
													<div class="sub-child">
                                        ...
                                        <div class="width-75 for-padding header-menu" id="b2">
                                            <div class="dis-flex" id="active_Current_Tabs3">
												...
												<div class="width-33 middle-list title-list">
													...
													<a href="<?php echo $site_url; ?>ecommerce-development-services" class="title">eCommerce Development Services</a>
                                        ...
                                        <div class="width-75 header-menu" id="b3">
                                            <div class="dis-flex" id="active_Current_Tabs4">
												<div class="width-25 for-padding middle-list">
                                                    <a href="<?php echo $site_url; ?>software-quality-assurance-testing-services" class="title">QA & Testing</a>
                                                    <div class="sub-child">
                                                        ...
                                                        <a href="<?php echo $site_url; ?>automated-testing-services">Automated Testing</a>
                                                    </div>
                                        ...
                                        <!-- <div class="width-75 header-menu" id="b3">
                                            <div class="dis-flex" id="active_Current_Tabs4">
												<div class="width-50 for-padding middle-list">
													<span class="title">Technology</span>
													<div class="sub-child">
														<a href="<?php echo $site_url; ?>best-magento-ecommerce-development-services-company-india">Magento</a>
														<a href="<?php echo $site_url; ?>shopify-development-services">Shopify</a>
                                                ...
                                                <div class="width-50 last-list for-padding bg-gray">
                                                    <span class="title with-border">eCommerce</span>
                                                    <p>Boost your online retail business with eCommerce services by ValueCoders for your ecommerce to succeed in today's complex online ecosystem.</p>
												...
												<div class="width-33 middle-list">
                                                    <a href="<?php echo $site_url; ?>new_page" class="title">Solutions</a>
													<div class="sub-child">
														<a href="<?php echo $site_url; ?>new_page">B2C eCommerce</a>
														<a href="<?php echo $site_url; ?>new_page">B2B eCommerce</a>
														<a href="<?php echo $site_url; ?>new_page">Web Portal</a>
														<a href="<?php echo $site_url; ?>new_page">Supply Chain Automation</a>
													</div>
												</div>
												<div class="width-33 middle-list">
                                                    <a href="<?php echo $site_url; ?>new_page" class="title">Services</a>
													<div class="sub-child">
														<a href="<?php echo $site_url; ?>new_page">eCommerce Consulting</a>
														<a href="<?php echo $site_url; ?>new_page">eCommerce Implementation</a>
														<a href="<?php echo $site_url; ?>new_page">Digital Consulting</a>
														<a href="<?php echo $site_url; ?>new_page">eCommerce Web Design</a>
													</div>
												</div>
                                            ...
                                            <div class="dis-flex" id="active_Current_Tabs5">
                                                <div class="width-33 middle-list">
													...
													<div class="sub-child">
														...
														<!-- <a href="<?php echo $site_url; ?>new_page">Big Data Consulting & Management</a> -->
												...
												<div class="width-33 middle-list">
													...
													<div class="sub-child">
														...
														<!-- <a href="<?php echo $site_url; ?>new_page">Azure</a> -->
													</div>
                                                </div>
                        ...
                        <!-- <li class="menu-item-has-children small-menu"><a href="<?php echo $site_url; ?>software-quality-assurance-testing-services">QA & Testing</a>
                            <div class="small-menu-inner">
                                <a href="<?php echo $site_url; ?>hire-developers/software-qa-testers-india">Hire Software QA</a>
                                <a href="<?php echo $site_url; ?>application-testing-services">Application Testing</a>
                                <a href="<?php echo $site_url; ?>new_page">Software Product Testing</a>
                ...
                <ul>
                    <li><a href="<?php echo $site_url; ?>software-development-services-company">Software Development</a> <span class="arrow-btn" onclick="innermenu(this, 'inner0')"></span>
                        <div class="first-inner service-title" id="inner0">
                            ...
                            <div>
                                <a href="<?php echo $site_url; ?>it-strategy-consulting-firms">Software Consulting</a>
                            ...
                            <div>
                                ...
                                <a href="<?php echo $site_url; ?>white-label-services">Whitelabel Services</a>
                    ...
                    <!-- <li><a href="<?php echo $site_url; ?>ecommerce-app-development-services-company">eCommerce</a> <span class="arrow-btn" onclick="innermenu(this, 'inner2')"></span>
                        <div class="first-inner service-title" id="inner2">
                            <a href="javascript:void(0)">Technology</a> <span class="arrow-btn" onclick="innermenu(this, 'subInner20')"></span>
                            <div class="inner-list service-inner" id="subInner20">
                                <a href="<?php echo $site_url; ?>best-magento-ecommerce-development-services-company-india">Magento</a>
                                <a href="<?php echo $site_url; ?>shopify-development-services">Shopify</a>
                            </div>

                            <a href="<?php echo $site_url; ?>new_page">Solutions</a> <span class="arrow-btn" onclick="innermenu(this, 'subInner21')"></span>
                            <div class="inner-list service-inner" id="subInner21">
                                <a href="<?php echo $site_url; ?>new_page">B2C eCommerce</a>
                                <a href="<?php echo $site_url; ?>new_page">B2B eCommerce</a>
                                <a href="<?php echo $site_url; ?>new_page">Web Portal</a>
                                <a href="<?php echo $site_url; ?>new_page">Supply Chain Automation</a>
                            ...
                            <a href="<?php echo $site_url; ?>new_page">Services</a> <span class="arrow-btn" onclick="innermenu(this, 'subInner22')"></span>
                            <div class="inner-list service-inner" id="subInner22">
                                <a href="<?php echo $site_url; ?>new_page">eCommerce Consulting</a>
                                <a href="<?php echo $site_url; ?>new_page">eCommerce Implementation</a>
                                <a href="<?php echo $site_url; ?>new_page">Digital Consulting</a>
                                <a href="<?php echo $site_url; ?>new_page">eCommerce Web Design</a>
                    ...
                    <li><a href="javascript:void(0)">Others</a> <span class="arrow-btn" onclick="innermenu(this, 'inner3')"></span>
                        <div class="first-inner service-title" id="inner3">
                            <a href="<?php echo $site_url; ?>business-intelligence-consulting-services">Dashboards & Analytics</a> <span class="arrow-btn" onclick="innermenu(this, 'subInner23')"></span>
                            <div class="inner-list service-inner" id="subInner23">
                                <a href="<?php echo $site_url; ?>big-data-application-development-services-company">Data Analytics Consulting & Management</a>
                                <!-- <a href="<?php echo $site_url; ?>new_page">Big Data Consulting & Management</a> -->
                                <a href="<?php echo $site_url; ?>microsoft-power-bi-development-services-company">Microsoft Power BI</a>
                            </div>
                            <a href="<?php echo $site_url; ?>devops-consulting-engineering-services-company">DevOps</a> <span class="arrow-btn" onclick="innermenu(this, 'subInner22')"></span>
                            <div class="inner-list service-inner" id="subInner22">
                                <a href="<?php echo $site_url; ?>devops-consulting-engineering-services-company">DevOps Consulting</a>
                                <a href="<?php echo $site_url; ?>amazon-aws-partner-company-india">Amazon AWS</a>
                                <!-- <a href="<?php echo $site_url; ?>new_page">Azure</a> -->
